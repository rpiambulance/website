angular.module('RPIAAboutCtrl', []).controller('RPIAAboutCtrl', ['$scope', function($scope) {
    ...
    $scope.sections = [
        ...
        },
        {
            ...
            header: '',
            body: '<img class="img-responsive center-block" src="img/old_fleet.jpg" width="75%">'
        },
        {
            internal_title: 'History',
            header: 'Our History',
            body: 'RPI Ambulance was founded in [YEAR] as the first EMS agency in Troy and the surrounding ' +
