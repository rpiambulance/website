angular.module('RPIAAboutCtrl', []).controller('RPIAAboutCtrl', ['$scope', function($scope) {
    ...
    $scope.aboutText = 'RPI Ambulance is a student run and operated Basic Life Support (BLS) transporting ambulance ' +
    ...
    $scope.historyHeader = 'Our History';
    $scope.historyText = 'RPI Ambulance was founded in [YEAR] as the first EMS agency in Troy and the surrounding ' +
