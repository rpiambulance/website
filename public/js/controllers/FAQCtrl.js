angular.module('FAQCtrl', []).controller('FAQCtrl', ['$scope', '$sce', function($scope, $sce) {
    ...
    $scope.sections = [
        ...
        {header:'How much does an ambulance ride to the hospital cost?', body: 'Services provided by RPI Ambulance ' +
        ...
        {header:'What training is provided to me and what positions can I achieve?', body: 'We provide training for ' +
        ...
        {header:'I am an EMT but am not a New York State EMT. What now?', body: 'Great! We can get you information ' +
        ...
        {header:'Are there any requirements to join?', body: 'Just one! Each year all of our members have to attend ' +
            ...
            'contact us if you have any further headers at <a href="mailto:officers@rpiambulance.com">officers@rpiambulance.com</a>'}
    ];
