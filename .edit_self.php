...
try {
  ...
  $statement = $connection->prepare("UPDATE members SET cell_phone=:cell_phone, home_phone=:home_phone, rpi_address=:rpi_address, home_address=:home_address WHERE username = :username");
